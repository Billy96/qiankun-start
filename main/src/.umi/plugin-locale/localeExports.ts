...
import {
  ...
  IntlShape,
  MessageDescriptor,
} from '/Users/Billy/我的仓库/qiankun-start/main/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from '/Users/Billy/我的仓库/qiankun-start/main/node_modules/warning/warning.js';
...
export const localeInfo: {[key: string]: any} = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/Billy/我的仓库/qiankun-start/main/src/locales/en-US.ts')),
    },
    locale: 'en-US',
    antd: {
  ...
  'id-ID': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/Billy/我的仓库/qiankun-start/main/src/locales/id-ID.ts')),
    },
    locale: 'id-ID',
    antd: {
  ...
  'ja-JP': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/Billy/我的仓库/qiankun-start/main/src/locales/ja-JP.ts')),
    },
    locale: 'ja-JP',
    antd: {
  ...
  'pt-BR': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/Billy/我的仓库/qiankun-start/main/src/locales/pt-BR.ts')),
    },
    locale: 'pt-BR',
    antd: {
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/Billy/我的仓库/qiankun-start/main/src/locales/zh-CN.ts')),
    },
    locale: 'zh-CN',
    antd: {
  ...
  'zh-TW': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/Billy/我的仓库/qiankun-start/main/src/locales/zh-TW.ts')),
    },
    locale: 'zh-TW',
    antd: {
